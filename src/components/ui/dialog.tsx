...
const DialogContent = React.forwardRef<React.ElementRef<typeof DialogPrimitive.Content>, React.ComponentPropsWithoutRef<typeof DialogPrimitive.Content> & { onClickTitleBtn?: () => void }>(({ className, children, onClickTitleBtn, ...props }, ref) => (
  <DialogPortal>
    <DialogOverlay />
